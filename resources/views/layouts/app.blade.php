    ...
    <style>
        ...
        * {
        ...
        .mobile-menu {
            ...
            width: 280px;
            height: 100vh;
            background: linear-gradient(180deg, #170b22 0%, #0b0511 100%);
...
<body>
    ...
    <header>
        <div class="nav">
            <div style="display: flex; align-items: center;">
                <a href="{{ route('index') }}" class="logo" style="margin-right: 50px;"><img
                        src="{{ asset('assets/images/logo-2.png') }}" alt="ArihantPLUS" class="logo-img"></a>
                <nav class="links">
    ...
    <footer>
        ...
        <div class="footer-main">
            <div class="footer-col brand-col">
                <div class="footer-logo">
                    <a href="{{ route('index') }}" class="logo"><img src="{{ asset('assets/images/logo-2.png') }}"
                            alt="ArihantPLUS" class="logo-img"></a>
                </div>
        ...
        <div class="footer-sebi">
            ...
            <p class="sebi-notice">Investments in securities market are subject to market risks; read all the related
                documents carefully before investing. Brokerage will not exceed the SEBI prescribed limit. The
                securities are quoted as an example and not as a recommendation.</p>
            <p class="sebi-attention"><strong>Attention Investors:</strong> KYC is one time exercise while dealing in
                securities markets. Prevent unauthorised transactions in your account — update your mobile numbers/email
                IDs with your stockbrokers. Receive information of your transactions directly from Exchange on your
                mobile/email at the end of the day. Update your Mobile Number with your Depository Participant to
                receive alerts for all debit and other important transactions in your demat account directly from
                CDSL/NSDL on the same day.</p>
            <p class="sebi-links">
