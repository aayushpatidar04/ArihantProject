...
@section('title', 'Goodies Distribution — ArihantPLUS')
...
@section('content')
        ...
        <div class="scanner-card">
            ...
            <div id="result" class="result-box">
                ...
                <div class="action-btns" id="actions" style="display:none">
                    <button class="btn-allocate" onclick="confirmed()">✓ Mark Confirmed</button>
    ...
    <script>
        ...
        async function validateQr() {
            ...
            processing = true;
            try {
                const res = await fetch('{{ route("finbridge.validate") }}', {
                    method: 'POST',
                    headers: {
        ...
        async function confirmed() {
            ...
            try {
                const res = await fetch('{{ route("finbridge.confirmed") }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                ...
                if (data.success) {
                    ...
                    document.getElementById('resultTitle').innerHTML = 'Goodies Collected';
                } else {
