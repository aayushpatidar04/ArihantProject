...
<div class="admin-page">
    <div class="admin-wrap">
        ...
        <div class="admin-section">
            <table>
                <thead><tr><th>Referrer</th><th>Referred Email</th><th>Status</th><th>Points</th><th>Date</th></tr></thead>
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="5" style="text-align:center;color:var(--muted);padding:40px">No referrals yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
