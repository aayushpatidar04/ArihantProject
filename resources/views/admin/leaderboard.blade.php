...
@push('styles')
    <style>
        ...
        .overall-table .total-score {
            color: #8ff0b3;
            font-weight: 700
        }

        .overall-table .participant {
            font-weight: 600;
            white-space: nowrap
        }
    ...
    <div class="admin-wrap">
        <div class="admin-header">
            ...
            <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
                @permission('leaderboard', 'export')
                <a href="{{ route('admin.export', ['type' => 'leadscore']) }}" class="btn btn-primary"
