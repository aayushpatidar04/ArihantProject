...
<head>
    ...
    <title>You're Invited — ArihantPLUS</title>
    <style>
        body {
            margin: 0;
            padding: 0;
        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <div class="wrapper">
                    ...
                    <div class="content">
                        <div class="greeting">Hi {{ $referredName }},</div>
                        ...
                        <p>This is your opportunity to explore the future of Artificial Intelligence, Algorithmic
                            Trading, Technology, and Financial Markets—all under one roof.</p>
                        ...
                        <p>🎟️ Book your ticket through the referral link shared by <span
                                class="highlight">{{ $referrer->full_name }}</span> and take the first step towards
                        ...
                        <p>Don’t miss the opportunity to be part of Central India’s Largest AI & ALGO CONCLAVE!</p>
