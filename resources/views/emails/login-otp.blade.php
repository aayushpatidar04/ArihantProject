        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <div class="wrapper">
                    ...
                    {{-- Content --}}
                    <div class="content">
                        <div class="greeting">Dear {{ $registration->full_name }},</div>

                        <p>Your One-Time Password (OTP) for authentication on the ARIHANT PLUS AI & ALGO CONCLAVE
                            registration portal is:</p>
