                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="560"
                                ...
                                <tr>
                                    <td style="padding:20px;">
                                        <p
                                            ...
                                            Event Details</p>
                                        <p style="margin:0 0 8px;font-size:14px;color:#f6f3fa;line-height:1.6;">📅  5th September 2026</p>
                                        <p style="margin:0 0 8px;font-size:14px;color:#f6f3fa;line-height:1.6;">📍  Labh Mandapam, Indore</p>
                                        <p style="margin:0;font-size:14px;color:#f6f3fa;line-height:1.6;">⏰  10:00 AM onwards</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:0 32px 32px;">
                            <p style="margin:0;font-size:13px;color:#7c7188;">AI Powered. Algo Driven.</p>
                        </td>
                    </tr>
                    <!-- Footer -->
                    <tr>
